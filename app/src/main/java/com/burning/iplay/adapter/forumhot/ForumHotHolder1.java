...
/**
 * @FileName ForumHotHolder1
 * @Author Jay_Ping
 * @Time 2017/3/7
 * @Email 1054335787@qq.com
 * @Desc 社区 热门推荐 只加载一张图片的
 */
public class ForumHotHolder1 extends ForumHotAdapterSum.MessageHolder{
    ...
    public ForumHotHolder1(View itemView) {
        super(itemView);
    }
